 ...
 *
 * use by [com.tree.cyxbs.common.utils.encrypt.UserInfoEncryption] for the current encrypt version,
 * you can getUpdateInfo the encrypt method in the future and keep compatibility
 * @see com.tree.cyxbs.common.utils.encrypt.UserInfoEncryption.onUpdate
 */
